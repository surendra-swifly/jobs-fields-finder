            ...
            for html_fields in html_elements:
                ...
                if label:
                    ...
                    total_fields.append({
                        ...
                        'placeholder': html_fields.attrib.get('placeholder',''),
...
if __name__ == '__main__':
    ...
    with open(f'{url.split("//")[1].split("/")[0]}.json', 'w', encoding="utf-8") as f:
        f.write(str(field_list_all).replace("'", '"').replace('\xa0', '').replace('\n', ''))
